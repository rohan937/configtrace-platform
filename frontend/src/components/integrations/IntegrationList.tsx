          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4 px-4 py-3">
                ...
                >
                  {integration.provider === "cloudflare" ? "Cloudflare" : integration.provider === "github" ? "GitHub" : integration.provider === "vercel" ? "Vercel" : integration.provider === "stripe" ? "Stripe" : integration.provider}
                </span>
