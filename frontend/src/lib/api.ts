...
export async function getSecurityCaseGraph(
  caseId: string,
  token?: string | null,
): Promise<SecurityCaseGraph> {
  return apiFetch(`/security/cases/${caseId}/graph`, { token });
}
...
export async function seedIncidentDemo(
  token?: string | null,
  provider: "github" | "aws" | "cloudflare" | "vercel" | "supabase" | "firebase" | "stripe" | "shopify" | "azure" | "google_cloud" | "twilio" | "sendgrid" | "auth0" | "datadog" | "clerk" | "pagerduty" | "linear" | "jira" | "gitlab" | "terraform_cloud" = "github",
