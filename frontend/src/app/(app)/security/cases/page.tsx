...
const PROVIDER_DEMO_CARDS: ProviderDemoCard[] = [
  ...
  },
  {
    provider: "linear",
    label: "Linear",
    intro: "Try the Linear security demo:",
    description:
      "Seed a review-safe Linear webhook configuration review with a webhook posture finding — no signing secret, non-HTTPS delivery, and broad resource scope — with related control-plane activity evidence, activity signal, risk × activity correlation, and a case. No real Linear sync, API keys, webhook secrets, delivery URLs, team IDs, payload contents, or customer data are stored.",
    seedButton: "Load Linear security demo",
  ...
  },
  {
    provider: "gitlab",
    label: "GitLab",
    intro: "Try the GitLab security demo:",
    description:
      "Seed a GitLab posture review demo using safe placeholder configuration evidence. No GitLab repo content, issue content, merge request titles, commit messages, branch names, CI variable names/values, webhook URLs, tokens, user identities, logs, artifacts, or PII are stored.",
    seedButton: "Load GitLab security demo",
