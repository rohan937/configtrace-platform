...
_RULE_META: dict[str, tuple[str, str, str]] = {
    ...
    # Firebase — M72C QA
    "firebase_storage_public_access_prevention_disabled": ("firebase", "high", "Security configuration"),
    "firebase_app_check_unenforced_services": ("firebase", "medium", "App security"),
    # Stripe
    ...
    "linear_team_auto_archive_disabled": ("linear", "low", "Team archive posture"),
    "linear_team_cycles_disabled": ("linear", "low", "Team workflow posture"),
    ...
    "linear_workspace_no_webhooks": ("linear", "low", "Workspace webhook posture"),
    "linear_workspace_no_integrations": ("linear", "low", "Workspace integration posture"),
    "linear_team_no_backlog_state": ("linear", "low", "Team workflow state posture"),
    "linear_team_no_started_state": ("linear", "low", "Team workflow state posture"),
    "linear_team_no_completed_state": ("linear", "medium", "Team workflow state posture"),
    "linear_team_no_canceled_state": ("linear", "low", "Team workflow state posture"),
    "linear_team_low_workflow_state_count": ("linear", "low", "Team workflow state posture"),
    "linear_team_no_labels": ("linear", "low", "Team label posture"),
    "linear_team_no_webhooks": ("linear", "low", "Team webhook posture"),
    ...
    "jira_permission_scheme_public_transition_issues": ("jira", "high", "Permission scheme posture"),
