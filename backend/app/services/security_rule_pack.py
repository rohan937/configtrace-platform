...
_RULE_META: dict[str, tuple[str, str, str]] = {
    ...
    "kubernetes_privileged_container": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_privileged_host_access": ("kubernetes", "critical", "Workload / Pod security"),
    "kubernetes_root_container": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_run_as_non_root_disabled": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_privilege_escalation_allowed": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_dangerous_linux_capability": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_all_capabilities_added": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_host_pid_enabled": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_host_ipc_enabled": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_host_network_enabled": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_dangerous_hostpath": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_container_runtime_socket_mounted": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_seccomp_unconfined": ("kubernetes", "high", "Workload / Pod security"),
    "kubernetes_apparmor_unconfined": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_writable_root_filesystem": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_mutable_image_tag": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_service_account_token_automount": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_sensitive_host_port": ("kubernetes", "medium", "Workload / Pod security"),
    "kubernetes_cluster_admin_binding": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_unauthenticated_cluster_admin": ("kubernetes", "critical", "RBAC / identity"),
    "kubernetes_authenticated_group_cluster_admin": ("kubernetes", "critical", "RBAC / identity"),
    "kubernetes_all_service_accounts_cluster_admin": ("kubernetes", "critical", "RBAC / identity"),
    "kubernetes_wildcard_rbac_permissions": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_rbac_bind_permission": ("kubernetes", "critical", "RBAC / identity"),
    "kubernetes_rbac_escalate_permission": ("kubernetes", "critical", "RBAC / identity"),
    "kubernetes_rbac_impersonate_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_service_account_token_creation": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_secret_read_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_secret_write_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_pod_exec_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_pod_attach_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_broad_workload_creation": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_rbac_modification_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_admission_webhook_modification_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_crd_modification_permission": ("kubernetes", "high", "RBAC / identity"),
    "kubernetes_public_load_balancer": ("kubernetes", "high", "Network exposure"),
    "kubernetes_sensitive_nodeport": ("kubernetes", "medium", "Network exposure"),
    "kubernetes_public_ingress_without_tls": ("kubernetes", "high", "Network exposure"),
    "kubernetes_hostless_catchall_ingress": ("kubernetes", "high", "Network exposure"),
    "kubernetes_public_gateway_listener": ("kubernetes", "high", "Network exposure"),
    "kubernetes_network_policy_allows_all_ingress": ("kubernetes", "high", "NetworkPolicy isolation"),
    "kubernetes_network_policy_allows_all_egress": ("kubernetes", "medium", "NetworkPolicy isolation"),
    "kubernetes_public_ipv4_cidr_allowed": ("kubernetes", "high", "NetworkPolicy isolation"),
    "kubernetes_public_ipv6_cidr_allowed": ("kubernetes", "high", "NetworkPolicy isolation"),
    "kubernetes_namespace_no_network_policy": ("kubernetes", "medium", "NetworkPolicy isolation"),
    "kubernetes_namespace_no_ingress_isolation": ("kubernetes", "medium", "NetworkPolicy isolation"),
    "kubernetes_namespace_no_egress_isolation": ("kubernetes", "medium", "NetworkPolicy isolation"),
    "kubernetes_validating_webhook_fail_open": ("kubernetes", "high", "Admission webhooks"),
    "kubernetes_mutating_webhook_fail_open": ("kubernetes", "medium", "Admission webhooks"),
    "kubernetes_broad_admission_webhook": ("kubernetes", "medium", "Admission webhooks"),
    "kubernetes_admission_webhook_external_http": ("kubernetes", "high", "Admission webhooks"),
    "kubernetes_psa_privileged_enforcement": ("kubernetes", "medium", "Pod Security Admission"),
    "kubernetes_psa_enforcement_missing": ("kubernetes", "medium", "Pod Security Admission"),
    "kubernetes_psa_invalid_enforcement": ("kubernetes", "medium", "Pod Security Admission"),
    "kubernetes_psa_weak_with_privileged_workloads": ("kubernetes", "high", "Pod Security Admission"),
    "kubernetes_namespace_weak_governance": ("kubernetes", "high", "Namespace governance"),
    "kubernetes_privileged_identity_in_weak_namespace": ("kubernetes", "high", "Namespace governance"),
    "kubernetes_privileged_workload_without_isolation": ("kubernetes", "high", "Namespace governance"),
    "kubernetes_namespace_resource_governance_missing": ("kubernetes", "low", "Resource governance"),
    # Okta (message 6 of 8)
    "okta_super_admin_assigned": ("okta", "critical", "Privileged identities & admin roles"),
    "okta_high_tier_admin_assigned": ("okta", "high", "Privileged identities & admin roles"),
    "okta_custom_admin_role_high_risk": ("okta", "critical", "Privileged identities & admin roles"),
    "okta_admin_role_broad_resource_set": ("okta", "high", "Privileged identities & admin roles"),
    "okta_unscoped_admin_role_assignment": ("okta", "medium", "Privileged identities & admin roles"),
    "okta_privileged_group_grants_super_admin": ("okta", "critical", "Privileged identities & admin roles"),
    "okta_privileged_group_grants_high_tier_admin": ("okta", "high", "Privileged identities & admin roles"),
    "okta_broad_privileged_group": ("okta", "high", "Privileged identities & admin roles"),
    "okta_deprovisioned_identity_retains_admin_privilege": ("okta", "high", "Identity lifecycle"),
    "okta_suspended_identity_retains_admin_privilege": ("okta", "medium", "Identity lifecycle"),
    "okta_dormant_privileged_identity": ("okta", "medium", "Identity lifecycle"),
    "okta_never_used_privileged_identity": ("okta", "medium", "Identity lifecycle"),
    "okta_deprovisioned_user_retains_app_assignment": ("okta", "medium", "Identity lifecycle"),
    "okta_suspended_user_retains_app_assignment": ("okta", "low", "Identity lifecycle"),
    "okta_signon_mfa_not_required": ("okta", "high", "Authentication & MFA"),
    "okta_signon_mfa_optional": ("okta", "medium", "Authentication & MFA"),
    "okta_broad_allow_rule_without_mfa": ("okta", "high", "Authentication & MFA"),
    "okta_phishing_resistant_not_required": ("okta", "medium", "Authentication & MFA"),
    "okta_weak_authenticator_enabled": ("okta", "low", "Authentication & MFA"),
    "okta_password_policy_weak_min_length": ("okta", "high", "Password policy"),
    "okta_password_policy_no_lockout": ("okta", "medium", "Password policy"),
    "okta_password_policy_no_history": ("okta", "medium", "Password policy"),
    "okta_password_policy_no_complexity": ("okta", "low", "Policy governance"),
    "okta_oidc_wildcard_redirect": ("okta", "high", "Applications & SSO"),
    "okta_oidc_http_redirect": ("okta", "medium", "Applications & SSO"),
    "okta_oidc_custom_scheme_redirect_non_native": ("okta", "medium", "Applications & SSO"),
    "okta_saml_response_signing_disabled": ("okta", "medium", "Applications & SSO"),
    "okta_saml_assertion_signing_disabled": ("okta", "medium", "Applications & SSO"),
    "okta_weak_token_endpoint_auth": ("okta", "medium", "Applications & SSO"),
    "okta_app_assigned_to_everyone_group": ("okta", "medium", "Applications & SSO"),
    # Microsoft Entra ID (message 6 of 8)
    "entra_global_admin_assigned": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_privileged_role_administrator_assigned": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_privileged_authentication_administrator_assigned": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_high_tier_admin_assigned": ("entra", "high", "Privileged identities & directory roles"),
    "entra_guest_global_admin": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_guest_has_high_privilege": ("entra", "high", "Privileged identities & directory roles"),
    "entra_disabled_guest_retains_high_privilege": ("entra", "high", "Identity lifecycle"),
    "entra_disabled_identity_retains_admin_privilege": ("entra", "high", "Identity lifecycle"),
    "entra_group_has_global_admin": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_group_has_high_privilege": ("entra", "high", "Privileged identities & directory roles"),
    "entra_guest_member_in_privileged_group": ("entra", "critical", "Privileged identities & directory roles"),
    "entra_privileged_group_broad_membership": ("entra", "high", "Privileged identities & directory roles"),
    "entra_service_principal_has_critical_privilege": ("entra", "critical", "Privileged service principals"),
    "entra_service_principal_has_high_privilege": ("entra", "high", "Privileged service principals"),
    "entra_disabled_service_principal_retains_privilege": ("entra", "high", "Identity lifecycle"),
    "entra_service_principal_can_manage_directory_roles": ("entra", "critical", "Privileged service principals"),
    "entra_service_principal_can_manage_app_role_assignments": ("entra", "critical", "Privileged service principals"),
    "entra_service_principal_can_grant_arbitrary_permissions": ("entra", "critical", "Privileged service principals"),
    "entra_service_principal_has_application_management_permission": ("entra", "high", "Privileged service principals"),
    "entra_service_principal_can_modify_conditional_access": ("entra", "high", "Privileged service principals"),
    "entra_service_principal_can_modify_authentication_methods": ("entra", "high", "Privileged service principals"),
    "entra_service_principal_has_directory_write_permission": ("entra", "high", "Privileged service principals"),
    "entra_service_principal_has_user_write_permission": ("entra", "medium", "Privileged service principals"),
    "entra_service_principal_has_group_write_permission": ("entra", "medium", "Privileged service principals"),
    "entra_tenant_wide_critical_delegated_consent": ("entra", "critical", "Consent & OAuth grants"),
    "entra_tenant_wide_high_risk_delegated_consent": ("entra", "high", "Consent & OAuth grants"),
    "entra_user_scoped_critical_consent": ("entra", "high", "Consent & OAuth grants"),
    "entra_user_scoped_high_risk_consent": ("entra", "medium", "Consent & OAuth grants"),
    "entra_external_unverified_app_tenant_wide_consent": ("entra", "critical", "Consent & OAuth grants"),
    "entra_ca_broad_access_without_mfa": ("entra", "high", "Conditional Access & MFA"),
    "entra_ca_access_without_mfa": ("entra", "medium", "Conditional Access & MFA"),
    "entra_ca_mfa_optional_within_grant_controls": ("entra", "medium", "Conditional Access & MFA"),
    "entra_ca_legacy_auth_not_blocked": ("entra", "high", "Conditional Access & MFA"),
    "entra_ca_report_only_broad_protection": ("entra", "medium", "Conditional Access & MFA"),
    "entra_weak_authentication_method_enabled": ("entra", "low", "Authentication methods"),
    "entra_authentication_strength_not_phishing_resistant": ("entra", "medium", "Authentication methods"),
    "entra_application_wildcard_redirect": ("entra", "high", "Applications & credentials"),
    "entra_application_http_redirect": ("entra", "medium", "Applications & credentials"),
    "entra_application_custom_scheme_redirect_unexpected": ("entra", "medium", "Applications & credentials"),
    "entra_application_expired_credential": ("entra", "medium", "Applications & credentials"),
    "entra_service_principal_expired_credential": ("entra", "medium", "Applications & credentials"),
    "entra_service_principal_assignment_not_required": ("entra", "low", "Applications & credentials"),
    "entra_disabled_user_retains_application_assignment": ("entra", "low", "Identity lifecycle"),
    "entra_dynamic_group_assigned_to_application": ("entra", "medium", "Groups & app assignment posture"),
    "entra_role_assignable_group_assigned_to_application": ("entra", "medium", "Groups & app assignment posture"),
    # Snowflake (message 6 of 8)
    "snowflake_user_accountadmin": ("snowflake", "critical", "Privileged users"),
    "snowflake_service_user_accountadmin": ("snowflake", "critical", "Privileged service identities"),
    "snowflake_user_securityadmin": ("snowflake", "high", "Privileged users"),
    "snowflake_user_can_manage_grants": ("snowflake", "high", "Grant administration & ownership"),
    "snowflake_user_sysadmin_or_useradmin": ("snowflake", "medium", "Privileged users"),
    "snowflake_disabled_privileged_user": ("snowflake", "high", "Identity lifecycle"),
    "snowflake_legacy_service_user_privileged": ("snowflake", "high", "Privileged service identities"),
    "snowflake_legacy_service_user": ("snowflake", "medium", "Privileged service identities"),
    "snowflake_custom_role_manage_grants": ("snowflake", "high", "Grant administration & ownership"),
    "snowflake_custom_role_manage_grants_identity_admin": ("snowflake", "critical", "Grant administration & ownership"),
    "snowflake_custom_role_high_privilege": ("snowflake", "high", "Privileged/custom roles"),
    "snowflake_role_controls_managed_access_schema": ("snowflake", "high", "Grant administration & ownership"),
    "snowflake_role_owns_security_integration_high_privilege": ("snowflake", "high", "Security integrations"),
    "snowflake_role_owns_storage_integration_high_privilege": ("snowflake", "medium", "Storage/external access integrations"),
    "snowflake_role_owns_external_access_integration_high_privilege": ("snowflake", "medium", "Storage/external access integrations"),
    "snowflake_role_owns_authentication_policy_high_privilege": ("snowflake", "medium", "Authentication policies"),
    "snowflake_role_owns_network_policy_high_privilege": ("snowflake", "medium", "Network policies"),
    "snowflake_high_privilege_role_owns_database": ("snowflake", "medium", "Grant administration & ownership"),
    "snowflake_future_ownership_grant": ("snowflake", "high", "Future grants"),
    "snowflake_public_future_ownership_grant": ("snowflake", "critical", "PUBLIC access"),
    "snowflake_public_future_write_access": ("snowflake", "high", "PUBLIC access"),
    "snowflake_public_future_data_access": ("snowflake", "high", "PUBLIC access"),
    "snowflake_public_future_broad_privilege": ("snowflake", "medium", "PUBLIC access"),
    "snowflake_network_policy_allows_anywhere": ("snowflake", "high", "Network policies"),
    "snowflake_mfa_optional_with_password": ("snowflake", "medium", "Authentication policies"),
    "snowflake_mfa_optional_for_person_auth": ("snowflake", "medium", "Authentication policies"),
    "snowflake_mfa_password_only_scope": ("snowflake", "medium", "Authentication policies"),
    "snowflake_scim_critical_privilege_run_as": ("snowflake", "critical", "Security integrations"),
    "snowflake_scim_high_privilege_run_as": ("snowflake", "high", "Security integrations"),
    "snowflake_saml_integration_incomplete_config": ("snowflake", "medium", "Security integrations"),
    "snowflake_user_high_risk_future_grant": ("snowflake", "medium", "Future grants"),
    "sentry_active_organization_owner": ("sentry", "critical", "Privileged organization members"),
    "sentry_active_organization_manager": ("sentry", "high", "Privileged organization members"),
    "sentry_active_organization_admin": ("sentry", "medium", "Privileged organization members"),
    "sentry_pending_privileged_invitation": ("sentry", "high", "Pending privileged invitations"),
    "sentry_member_broad_routing_authority": ("sentry", "medium", "Privileged organization members"),
    "sentry_member_team_admin_without_org_role": ("sentry", "medium", "Privileged organization members"),
    "sentry_team_has_broad_routing_authority": ("sentry", "medium", "Privileged teams & project access"),
    "sentry_team_has_unresolved_members": ("sentry", "medium", "Privileged teams & project access"),
    "sentry_metric_alert_unrouted": ("sentry", "high", "Alert coverage"),
    "sentry_issue_alert_unrouted": ("sentry", "high", "Alert coverage"),
    "sentry_metric_alert_disabled_with_routing_configured": ("sentry", "low", "Alert coverage"),
    "sentry_issue_alert_disabled_with_routing_configured": ("sentry", "low", "Alert coverage"),
    "sentry_alert_targets_missing_team": ("sentry", "high", "Alert notification routing"),
    "sentry_alert_targets_missing_member": ("sentry", "high", "Alert notification routing"),
    "sentry_alert_references_inactive_member": ("sentry", "medium", "Alert notification routing"),
    "sentry_alert_references_disabled_integration": ("sentry", "high", "Alert notification routing"),
    "sentry_ownership_targets_missing_team": ("sentry", "high", "Ownership routing"),
    "sentry_ownership_targets_missing_member": ("sentry", "high", "Ownership routing"),
    "sentry_ownership_targets_inactive_member": ("sentry", "medium", "Ownership routing"),
    "sentry_repository_pending_deletion": ("sentry", "low", "Configuration integrity"),
}
