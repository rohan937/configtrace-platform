...
# and tests/test_provider_certification_entra.py, which independently
# re-derives and pins the exact 45-ID set. See
...
# tests/test_provider_certification_entra.py (pins the exact 45-ID set
