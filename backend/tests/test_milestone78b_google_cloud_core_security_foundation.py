...
class TestCapabilityMatrix:
    ...
    def test_other_security_capabilities_after_m78g(self):
        """M78D/E/F landed ingestion/signals/correlations; M78G lit up demo+case."""
        from app.services.provider_capability_matrix_service import (
            get_provider_capability,
        )
        cap = get_provider_capability("google_cloud")
        ...
        assert cap.security.evidence_timeline is True  # M78G complete
        assert cap.security.evidence_graph is True  # M78G complete
